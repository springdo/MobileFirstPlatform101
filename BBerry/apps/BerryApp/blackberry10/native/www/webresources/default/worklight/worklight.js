...
function MD5(a){function c(a,d){var b,c,e,f,g;e=a&2147483648;f=d&2147483648;b=a&1073741824;c=d&1073741824;g=(a&1073741823)+(d&1073741823);return b&c?g^2147483648^e^f:b|c?g&1073741824?g^3221225472^e^f:g^1073741824^e^f:g^e^f}function b(a,d,b,e,f,g,k){a=c(a,c(c(d&b|~d&e,f),k));return c(a<<g|a>>>32-g,d)}function e(a,d,b,e,f,g,k){a=c(a,c(c(d&e|b&~e,f),k));return c(a<<g|a>>>32-g,d)}function f(a,d,b,e,f,g,k){a=c(a,c(c(d^b^e,f),k));return c(a<<g|a>>>32-g,d)}function k(a,d,b,e,f,g,k){a=c(a,c(c(b^(d|~e),f),
k));return c(a<<g|a>>>32-g,d)}function l(a){var d,b,e=[];for(b=0;3>=b;b++)d=a>>>8*b&255,e=e.concat(d);return e}var d=[],m,o,p,q,g,i,h,j,d=function(a){var d,b=a.length;d=b+8;for(var e=16*((d-d%64)/64+1),c=[],g=0,f=0;f<b;)d=(f-f%4)/4,g=8*(f%4),c[d]|=a[f]<<g,f++;d=(f-f%4)/4;c[d]|=128<<8*(f%4);c[e-2]=b<<3;c[e-1]=b>>>29;return c}(a);g=1732584193;i=4023233417;h=2562383102;j=271733878;for(a=0;a<d.length;a+=16)m=g,o=i,p=h,q=j,g=b(g,i,h,j,d[a+0],7,3614090360),j=b(j,g,i,h,d[a+1],12,3905402710),h=b(h,j,g,i,
...
i=f(i,h,j,g,d[a+2],23,3299628645),g=k(g,i,h,j,d[a+0],6,4096336452),j=k(j,g,i,h,d[a+7],10,1126891415),h=k(h,j,g,i,d[a+14],15,2878612391),i=k(i,h,j,g,d[a+5],21,4237533241),g=k(g,i,h,j,d[a+12],6,1700485571),j=k(j,g,i,h,d[a+3],10,2399980690),h=k(h,j,g,i,d[a+10],15,4293915773),i=k(i,h,j,g,d[a+1],21,2240044497),g=k(g,i,h,j,d[a+8],6,1873313359),j=k(j,g,i,h,d[a+15],10,4264355552),h=k(h,j,g,i,d[a+6],15,2734768916),i=k(i,h,j,g,d[a+13],21,1309151649),g=k(g,i,h,j,d[a+4],6,4149444226),j=k(j,g,i,h,d[a+11],10,3174756917),
h=k(h,j,g,i,d[a+2],15,718787259),i=k(i,h,j,g,d[a+9],21,3951481745),g=c(g,m),i=c(i,o),h=c(h,p),j=c(j,q);return l(g).concat(l(i),l(h),l(j))}var hexcase=0,b64pad="",chrsz=8;function hex_sha1(a){return binb2hex(core_sha1(str2binb(a),a.length*chrsz))}function b64_sha1(a){return binb2b64(core_sha1(str2binb(a),a.length*chrsz))}function str_sha1(a){return binb2str(core_sha1(str2binb(a),a.length*chrsz))}function hex_hmac_sha1(a,c){return binb2hex(core_hmac_sha1(a,c))}
...
function core_sha1(a,c){a[c>>5]|=128<<24-c%32;a[(c+64>>9<<4)+15]=c;for(var b=Array(80),e=1732584193,f=-271733879,k=-1732584194,l=271733878,d=-1009589776,m=0;m<a.length;m+=16){for(var o=e,p=f,q=k,g=l,i=d,h=0;80>h;h++){b[h]=16>h?a[m+h]:rol(b[h-3]^b[h-8]^b[h-14]^b[h-16],1);var j=safe_add(safe_add(rol(e,5),sha1_ft(h,f,k,l)),safe_add(safe_add(d,b[h]),sha1_kt(h))),d=l,l=k,k=rol(f,30),f=e,e=j}e=safe_add(e,o);f=safe_add(f,p);k=safe_add(k,q);l=safe_add(l,g);d=safe_add(d,i)}return[e,f,k,l,d]}
function sha1_ft(a,c,b,e){return 20>a?c&b|~c&e:40>a?c^b^e:60>a?c&b|c&e|b&e:c^b^e}function sha1_kt(a){return 20>a?1518500249:40>a?1859775393:60>a?-1894007588:-899497514}function core_hmac_sha1(a,c){var b=str2binb(a);16<b.length&&(b=core_sha1(b,a.length*chrsz));for(var e=Array(16),f=Array(16),k=0;16>k;k++)e[k]=b[k]^909522486,f[k]=b[k]^1549556828;b=core_sha1(e.concat(str2binb(c)),512+c.length*chrsz);return core_sha1(f.concat(b),672)}
...
function SHA256(a){function c(a,b){var c=(a&65535)+(b&65535);return(a>>16)+(b>>16)+(c>>16)<<16|c&65535}function b(a,b){return a>>>b|a<<32-b}a=function(a){for(var a=a.replace(/\r\n/g,"\n"),b="",c=0;c<a.length;c++){var l=a.charCodeAt(c);128>l?b+=myStringFromCharCode(l):(127<l&&2048>l?b+=myStringFromCharCode(l>>6|192):(b+=myStringFromCharCode(l>>12|224),b+=myStringFromCharCode(l>>6&63|128)),b+=myStringFromCharCode(l&63|128))}return b}(a);return function(a){for(var b="",c=0;c<4*a.length;c++)b+="0123456789abcdef".charAt(a[c>>
2]>>8*(3-c%4)+4&15)+"0123456789abcdef".charAt(a[c>>2]>>8*(3-c%4)&15);return b}(function(a,f){var k=[1116352408,1899447441,3049323471,3921009573,961987163,1508970993,2453635748,2870763221,3624381080,310598401,607225278,1426881987,1925078388,2162078206,2614888103,3248222580,3835390401,4022224774,264347078,604807628,770255983,1249150122,1555081692,1996064986,2554220882,2821834349,2952996808,3210313671,3336571891,3584528711,113926993,338241895,666307205,773529912,1294757372,1396182291,1695183700,1986661051,
2177026350,2456956037,2730485921,2820302411,3259730800,3345764771,3516065817,3600352804,4094571909,275423344,430227734,506948616,659060556,883997877,958139571,1322822218,1537002063,1747873779,1955562222,2024104815,2227730452,2361852424,2428436474,2756734187,3204031479,3329325298],l=[1779033703,3144134277,1013904242,2773480762,1359893119,2600822924,528734635,1541459225],d=Array(64),m,o,p,q,g,i,h,j,r,n,s,t;a[f>>5]|=128<<24-f%32;a[(f+64>>9<<4)+15]=f;for(r=0;r<a.length;r+=16){m=l[0];o=l[1];p=l[2];q=l[3];
g=l[4];i=l[5];h=l[6];j=l[7];for(n=0;64>n;n++)d[n]=16>n?a[n+r]:c(c(c(b(d[n-2],17)^b(d[n-2],19)^d[n-2]>>>10,d[n-7]),b(d[n-15],7)^b(d[n-15],18)^d[n-15]>>>3),d[n-16]),s=c(c(c(c(j,b(g,6)^b(g,11)^b(g,25)),g&i^~g&h),k[n]),d[n]),t=c(b(m,2)^b(m,13)^b(m,22),m&o^m&p^o&p),j=h,h=i,i=g,g=c(q,s),q=p,p=o,o=m,m=c(s,t);l[0]=c(m,l[0]);l[1]=c(o,l[1]);l[2]=c(p,l[2]);l[3]=c(q,l[3]);l[4]=c(g,l[4]);l[5]=c(i,l[5]);l[6]=c(h,l[6]);l[7]=c(j,l[7])}return l}(function(a){for(var b=[],c=0;c<8*a.length;c+=8)b[c>>5]|=(a.charCodeAt(c/
...
EncryptedCache.prototype[api.secureRandom]=function(a,c){var a="function"!==typeof a?function(){}:a,b,e={};if("number"===typeof c&&parseFloat(c)==parseInt(c,10)&&!isNaN(c)&&0<c)e.bytes=c;if(WL.EnvProfile.isEnabled(WL.EPField.SUPPORT_WL_SERVER_CHANGE)){b=WL.Client.getAppProperty(WL.AppProp.APP_SERVICES_RELATIVE_URL)+"random";var f=!1,k=WL.AppProp.WLCLIENT_TIMEOUT_IN_MILLIS;new WLJSX.Ajax.Request(b,{method:"get",timeout:k,parameters:e,onSuccess:function(b){clearTimeout(l);f=!0;a(b.responseText)},onFailure:function(){clearTimeout(l);
f=!0;a(ERROR_SECURE_RANDOM_GENERATOR_UNAVAILABLE)}});var l=setTimeout(function(){f||a(ERROR_SECURE_RANDOM_GENERATOR_UNAVAILABLE)},k)}else b=WL.EnvProfile.isEnabled(WL.EPField.WEB)&&WL.Client.getEnvironment()!=WL.Env.MOBILE_WEB?WL.StaticAppProps.POSTFIX_APP_SERVICES_URL+"random":WL.Client.getAppProperty(WL.AppProp.APP_SERVICES_URL)+"random",WLJQ.ajax({url:b,method:"get",data:e,timeout:WL.AppProp.WLCLIENT_TIMEOUT_IN_MILLIS}).done(function(b){a(b)}).fail(function(){a(ERROR_SECURE_RANDOM_GENERATOR_UNAVAILABLE)})};
EncryptedCache.prototype[api.open]=function(a,c,b,e){try{WL.Validators.validateArguments(["string","boolean",WL.Validators.validateFunctionOrNull,WL.Validators.validateFunctionOrNull],arguments,"WL.EncryptedCache.open")}catch(f){console.log(f);if(e)return e(ERROR_INVALID_PARAMETER);throw ERROR_INVALID_PARAMETER;}if(void 0===a||""===a){console.log("Error: credentials is undefined or empty.");if(e)return e(ERROR_INVALID_PARAMETER);throw ERROR_INVALID_PARAMETER;}if(this.DPK){var k=null;this.close(function(){},
function(a){k=a});if(null!==k)return e(k)}if(!localStorage){if(e)return e(ERROR_LOCAL_STORAGE_NOT_SUPPORTED);throw ERROR_LOCAL_STORAGE_NOT_SUPPORTED;}if(this.keyCreationContext){if(e)return e(ERROR_KEY_CREATION_IN_PROGRESS);throw ERROR_KEY_CREATION_IN_PROGRESS;}var l=localStorage.getItem(this.SALT_KEY);if(null===l){if(!c){if(e)return e(ERROR_NO_EOC);throw ERROR_NO_EOC;}this.keyCreationContext={credentials:a,salt:""+this[api.random](),onCompleteHandler:b,onErrorHandler:e};var d=this;this[api.secureRandom](function(a){if(a==
...
function reEncryptStorage(a,c,b,e){function f(a){console.log(a);if(c)c(ERROR_MIGRATION);else throw ERROR_MIGRATION;}var k=[MD5(""+b[api.random]())];b.encryptor.rawEncrypt(b.DPK,e,k[0],function(c){localStorage.setItem(b.CIPHER_KEY,c);reEncryptKeys(a,f,b)},f)}
function reEncryptKeys(a,c,b){function e(){0<k.length?(l=k.pop(),readUsingHashedKey(l,b,f,c)):(localStorage.setItem(b.VERSION,"1"),a&&a(OK))}function f(a){writeUsingHashedKey(l,a,b,e,c)}for(var k=[],l="",d=localStorage.length-1;0<=d;d--){var m=localStorage.key(d);0===m.indexOf(b.STORAGE_PREFIX)&&k.push(m)}e()}function readUsingHashedKey(a,c,b,e){a=localStorage.getItem(a);c.encryptor.rawDecrypt(a,c.DPK,b,e)}
function writeUsingHashedKey(a,c,b,e,f){var k=b.STORAGE_PREFIX,l=a.replace(k,""),a=[MD5(l+b[api.random]())];b.encryptor.rawEncrypt(c,b.DPK,a[0],function(a){localStorage.setItem(k+l,a);e()},f)}
...
a=SHA256(a);if(null===c){if(localStorage.removeItem(this.STORAGE_PREFIX+a),b)return b(OK)}else{var k=[MD5(a+this[api.random]())],l=this.STORAGE_PREFIX;this.encryptor.rawEncrypt(Base64.encode(c),this.DPK,k[0],function(c){localStorage.setItem(l+a,c);b&&b(OK)},e)}};
...
NativeEncryptor.prototype.rawEncrypt=function(a,c,b,e,f){try{WL.Validators.validateArguments(["string","string","object","function","function"],arguments,"NativeEncryptor.prototype.rawEncrypt")}catch(k){console.log(k);if(f)return f(ERROR_INVALID_PARAMETER);throw ERROR_INVALID_PARAMETER;}var l=a,d=c,m=a2h(b);if(!d||!l||!m||null===d||null===l||null===m||1>d.length||1>l.length||1>m.length){if(f)return f(ERROR_INVALID_PARAMETER);throw ERROR_INVALID_PARAMETER;}cordova.exec(e,function(){f()},"SecurityPlugin",
"encrypt",[d,l,m])};
NativeEncryptor.prototype.rawDecrypt=function(a,c,b,e){try{WL.Validators.validateArguments(["string","string","function","function"],arguments,"NativeEncryptor.prototype.rawDecrypt")}catch(f){console.log(f);if(e)return e(ERROR_INVALID_PARAMETER);throw ERROR_INVALID_PARAMETER;}var k=JSON.parse(a),l=k.ct,d=c,m=k.iv;if(!d||!l||!m||null===d||null===l||null===m||1>d.length||1>l.length||1>m.length){if(e)return e(ERROR_INVALID_PARAMETER);throw ERROR_INVALID_PARAMETER;}cordova.exec(b,function(a){console.log(a);
e(ERROR_UNKNOWN)},"SecurityPlugin","decrypt",[d,k.ct,m])};function NativePBKDF2(){}
NativePBKDF2.prototype.deriveKey=function(a,c,b,e,f,k){try{WL.Validators.validateArgument("string",a,"NativePBKDF2.prototype.deriveKey");WL.Validators.validateArgument("string",c,"NativePBKDF2.prototype.deriveKey");WL.Validators.validateArgument(function(a){"function"!==typeof a&&this.logAndThrow("Invalid value '"+WLJSX.Object.toJSON(a)+"' ("+typeof a+"), expected type 'function' for parameter onCompleteHandler.","NativePBKDF2.prototype.deriveKey")},f,"");WL.Validators.validateArgument(function(a){"function"!==
typeof a&&this.logAndThrow("Invalid value '"+WLJSX.Object.toJSON(a)+"' ("+typeof a+"), expected type 'function' for parameter onErrorHandler.","NativePBKDF2.prototype.deriveKey")},k,"");if(!("number"===typeof b&&Math.ceil(b)===Math.floor(b)))throw"Error: Invalid invocation of method NativePBKDF2.prototype.deriveKey; Invalid parameter type for argument 'num_iterations'";if(!("number"===typeof e&&Math.ceil(e)===Math.floor(e)))throw"Error: Invalid invocation of method NativePBKDF2.prototype.deriveKey; Invalid parameter type for argument 'num_bytes'";
}catch(l){console.log(l);if(k)return k(ERROR_INVALID_PARAMETER);throw ERROR_INVALID_PARAMETER;}if(!a||null===a||!c||null===c||!b||null===b||!e||null===e||1>c.length||0>parseInt(b,10))return k(ERROR_INVALID_PARAMETER);cordova.exec(f,function(a){console.log(a);k(ERROR_UNKNOWN)},"SecurityPlugin","keygen",[a,c,b,e])};function WebBasedEncryptor(){}
WebBasedEncryptor.prototype.rawEncrypt=function(a,c,b,e,f){var k=null;try{b=sjcl.codec.hex.toBits(a2h(b)),k=sjcl.json.encrypt(c,a,{iv:b})}catch(l){console.log(l);if(f)return f(ERROR_UNKNOWN);throw ERROR_UNKNOWN;}e&&e(k)};WebBasedEncryptor.prototype.rawDecrypt=function(a,c,b,e){var f=null;try{f=sjcl.json.decrypt(c,a)}catch(k){console.log(k);if(e)return e(ERROR_UNKNOWN);throw ERROR_UNKNOWN;}b&&b(f)};function WebBasedPBKDF2(){}
WebBasedPBKDF2.prototype.deriveKey=function(a,c,b,e,f,k){var l=null;try{l=sjcl.misc.pbkdf2(a,c,b,8*e)}catch(d){console.log(d);if(k)return k(ERROR_UNKNOWN);throw ERROR_UNKNOWN;}f&&f(binb2hex(l))};window.WL.EncryptedCache=new EncryptedCache;})();
